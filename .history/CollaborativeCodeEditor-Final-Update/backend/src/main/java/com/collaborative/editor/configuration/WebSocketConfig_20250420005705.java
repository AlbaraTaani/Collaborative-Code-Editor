...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry messageBrokerRegistry) {
        messageBrokerRegistry.enableSimpleBroker("/topic/file", "/topic/chat"); //subscribe to code updates and chat messages
        messageBrokerRegistry.setApplicationDestinationPrefixes("/app"); // to send messages
    }
