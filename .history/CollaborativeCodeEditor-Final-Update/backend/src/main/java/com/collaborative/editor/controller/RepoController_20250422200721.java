...
import com.collaborative.editor.service.RepoSecurityService;
import com.collaborative.editor.service.projectService.ProjectService;
import com.collaborative.editor.service.repoService.RepoService;
...
public class RepoController {
    ...
    // public ResponseEntity<Map<String, String>> createRepo(@RequestBody
    ...
    // return ResponseEntity.ok(Collections.singletonMap("repoId", repoId));

    // } catch (RepoCreationException e) {
    ...
    public ResponseEntity<Map<String, String>> createRepo(@RequestBody CreateRepoRequest request) {
        ...
        try {
            ...
            // 201 Created is more semantically correct than 200 OK here
            ...
            // Return 400 Bad Request with an error JSON
            return ResponseEntity
