...
const Control = ({ repo, currentFile, isConnected, subscribeToCodeUpdates }) => {
    ...
    const handleCreateNewPro = async (branchName) => {
        try {
    ...
    return (
        <div className="version-control">
            ...
            <div className="version-control-buttons">
                <button className="action-btn add-branch-btn" onClick={() => setShowProModal(true)}>
                    Add New Pro
                </button>
            ...
            <Action
                show={showProModal}
                title="Create New Pro"
                actionLabel="Create"
                inputs={[{ label: 'Pro Name', placeholder: 'Enter new branch name', name: 'branchName' }]}
                onConfirm={(inputValues) => {
                    handleCreateNewPro(inputValues.branchName);
            ...
            <Action
                ...
                actionLabel="Create"
                inputs={[
                    { label: 'Pro Name', placeholder: '/ Enter branch name', name: 'branchName' },
